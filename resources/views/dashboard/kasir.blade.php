...
<div class="d-flex">
    ...
    <div class="sidebar p-3 d-flex flex-column"
        ...
        <div class="text-center mb-4 mt-3">
            <img src="https://cdn-icons-png.flaticon.com/512/3075/3075977.png" 
                 width="60" 
                 class="mb-2">
            <h5 class="fw-bold text-white">Resto Kasir</h5>
            <small class="text-white-50">Kasir</small>
        </div>
            ...
            <li class="nav-item mb-2">
                <a href="{{ route('transaksi.index') }}" 
                   class="nav-link d-flex align-items-center text-white">
                    <i class="bi bi-cash-stack me-2"></i> Entri Transaksi
                </a>
            </li>
            <li class="nav-item mb-2">
    ...
    <div class="container py-5" style="margin-left: 270px;">
        ...
        <div class="welcome-box text-center mb-5 p-4 rounded-4 shadow-sm"
            ...
            <p class="mb-0">Semoga hari kamu lancar dan transaksi berjalan mulus 💰</p>
        </div>
        ...
        <div class="row justify-content-center g-4">
            ...
            <div class="col-md-4">
                <div class="card glass-card text-center p-4">
                    ...
                    <h5 class="fw-bold text-dark">Total Transaksi</h5>
                    <h3 class="fw-bolder text-primary">{{ $totalTransaksi }}</h3>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="card glass-card text-center p-4">
                    <i class="bi bi-card-list fs-1 text-info mb-2"></i>
